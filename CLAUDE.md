...
- В репозиториях, где пользователь является владельцем — можно пушить свободно в master/main
- В чужих репозиториях (форки, коллаборации) — создавай PR, не пушь напрямую в main/master
